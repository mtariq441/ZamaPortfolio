      ...
      <section className="py-12 md:py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 lg:px-16">
          <div className="text-center mb-12 md:mb-16">
            <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 md:mb-6" data-testid="text-pricing-title">
            ...
            {pricingPackages.map((pkg, index) => (
              <div key={index} className="relative">
                ...
                <CardHeader className={`text-center pb-4 sm:pb-6 pt-8 sm:pt-10 px-4 sm:px-6 ${pkg.popular ? "bg-gradient-to-b from-accent/10 to-transparent" : ""}`}>
                  <div className={`inline-flex mx-auto mb-4 p-3 rounded-2xl ${
                    pkg.color === "accent" 
                  ...
                  <CardTitle className="text-xl sm:text-2xl mb-2 font-bold" data-testid={`text-package-title-${index}`}>
                    {pkg.title}
                  </CardTitle>
                  <CardDescription className="mb-3 sm:mb-4 px-2">{pkg.description}</CardDescription>
                  <div className="mt-3 sm:mt-4">
                    <span className={`text-4xl sm:text-5xl font-bold ${pkg.color === "accent" ? "text-accent" : "text-primary"}`} data-testid={`text-package-price-${index}`}>
                      {pkg.price.split("/")[0]}
                    </span>
                    {pkg.price.includes("/") && (
